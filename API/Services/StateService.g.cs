...
namespace Vitec.Services
{
    ...
    public interface IStateService
    {
        ...
        Task<int> Create(State model);

        /// <summary>Updates a specific state by its primary key</summary>
        /// <param name="id">The primary key of the state</param>
        /// <param name="updatedEntity">The state data to be updated</param>
        /// <returns>The result of the operation</returns>
        Task<bool> Update(int id, State updatedEntity);

        /// <summary>Updates a specific state by its primary key</summary>
        /// <param name="id">The primary key of the state</param>
        /// <param name="updatedEntity">The state data to be updated</param>
        /// <returns>The result of the operation</returns>
        Task<bool> Patch(int id, JsonPatchDocument<State> updatedEntity);
    ...
    public class StateService : IStateService
    {
        ...
        public StateService(VitecContext dbContext, IFieldMapperService mapper)
        {
        ...
        /// <param name="model">The state data to be added</param>
        /// <returns>The result of the operation</returns>
        public async Task<int> Create(State model)
        {
        ...
        public async Task<bool> Update(int id, State updatedEntity)
        {
        ...
        /// <returns>The result of the operation</returns>
        /// <exception cref="Exception"></exception>
        public async Task<bool> Patch(int id, JsonPatchDocument<State> updatedEntity)
        {
        ...
        private async Task<int> CreateState(State model)
        {
        ...
        private async Task UpdateState(int id, State updatedEntity)
        {
            _dbContext.State.Update(updatedEntity);
            await _dbContext.SaveChangesAsync();
        }

        private async Task<bool> DeleteState(int id)
        {
        ...
        private async Task PatchState(int id, JsonPatchDocument<State> updatedEntity)
        {
